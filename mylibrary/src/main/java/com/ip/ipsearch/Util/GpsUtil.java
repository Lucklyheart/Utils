...
/**
 * WGS－84原始坐标系，一般用国际GPS纪录仪记录下来的经纬度，通过GPS定位拿到的原始经纬度，Google和高德地图定位的的经纬度（国外）都是基于WGS－84坐标系的；但是在国内是GCJ－02；
...
public class GpsUtil {
    ...
    public static double[] bd09_To_gps84(double lat, double lon) {
        ...
        //保留小数点后六位
        gps84[0] = NumberUtil.retain(gps84[0],6);
        gps84[1] = NumberUtil.retain(gps84[1],6);
        return gps84;
    }
