...
/**
 * Created by MR.Du on 2019/5/21.
 */
public class AcacheUtil {

    private static final int MAX_SIZE = 1000 * 1000 * 50; // 50 mb
    private static final int MAX_COUNT = Integer.MAX_VALUE; // 不限制存放数据的数量
    private static Map<String, AcacheUtil> mInstanceMap = new HashMap<>();
    private ACacheManager mCache;

    public static AcacheUtil get(Context ctx) {
        return get(ctx, "AcacheUtil");
    }
    ...
    public void put(String key, Bitmap value) {
        put(key, BitmapUtil.bitmapToByte(value));
    }
    ...
    public void put(String key, Bitmap value, int saveTime) {
        put(key,BitmapUtil.bitmapToByte(value), saveTime);
    }
    ...
    public void put(String key, Drawable value) {
        put(key, BitmapUtil.drawableToBitmap(value));
    }
    ...
    public void put(String key, Drawable value, int saveTime) {
        put(key, BitmapUtil.drawableToBitmap(value), saveTime);
    }
